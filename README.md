...
**Pre-release (v0.0.x-dev).** PRD v1.2 adopted 2026-07-20. Research MVP in progress:

- [ ] Pilot: 20 known incidents (Tier D, URL-driven backfill) — Sept 2026
- [ ] `ahid-cn-dataset-v0.1` (30–50 incidents) + Zenodo DOI — Oct 2026
- [ ] Methods white paper (SocArXiv) — Nov–Dec 2026
- [ ] Public website (Astro, six locales via template localization) — after interview season
...
docs/
  ...
  data_dictionary.csv         # Public dataset schema (v0.1 draft)
  methodology.md              # Methods documentation (skeleton)
