...
- [ ] `ahid-cn-dataset-v0.1` + Zenodo DOI — local staging build assembled 2026-07-27 (`release/ahid-cn-dataset-v0.1/`); actual release blocked on HRL-005 (license), HRL-008 (privacy QA signoff), HRL-009 (Zenodo/ORCID account) — Oct 2026 target
